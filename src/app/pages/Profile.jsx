        ...
        return (
            <div className="contentWrapper__base contentWrapper--thin__base">
                ...
                <form className="form__base" onSubmit={(e) => {
                    ...
                    <div>
                        <h2>Topic</h2>
                        <small>Tell us more about your topic</small>
                    </div>
                    ...
                    <p><input id="Cancer" name="interest-cancer"type="checkbox"/>Cancer</p>
                    <p><input id="Type 1 diabetes" name="interest-Type 1 diabetes" type="checkbox"/>Type 1 diabetes</p>
                    <p><input id="Type 2 diabetes" name="interest-Type 2 diabetes" type="checkbox"/>Type 2 diabetes</p>
                    <p><input id="Obesity" name="interest-Obesity" type="checkbox"/>Obesity</p>
                    <p><input id="Cardiovascular disease" name="interest-Cardiovascular disease" type="checkbox"/>Cardiovascular disease</p>
                    <p><input id="Chronic respiratory disease" name="interest-Chronic respiratory disease" type="checkbox"/>Chronic respiratory disease</p>
                    <p><input id="Mental Health" name="interest-Mental Health" type="checkbox"/>Mental Health</p>
                    <p><input id="Smoking" name="interest-Smoking" type="checkbox"/>Smoking</p>
                    <p><input id="Diet" name="interest-Diet" type="checkbox"/>Diet</p>
                    <p><input id="Physical activity" name="interest-Physical activity" type="checkbox"/>Physical activity</p>
                    <p><input id="Alcohol" name="interest-Alcohol" type="checkbox"/>Alcohol</p>
                    <p><input id="Natural environment" name="interest-Natural environment" type="checkbox"/>Natural environment</p>
                    <p><input id="Build environment" name="interest-Build environment" type="checkbox"/>Build environment</p>
                    <p><input id="Air pollution" name="interest-Air pollution" type="checkbox"/>Air pollution</p>
                    <p><input id="Climate change" name="interest-Climate change" type="checkbox"/>Climate change</p>
                    <p><input id="Sustainability" name="interest-Sustainability" type="checkbox"/>Sustainability</p>
                    <p><input id="Other" name="interest-Other" type="checkbox"/>Other</p>


                    <h2>Notify me about:</h2>
                    <p><input id="Conferences" name="interest-Conferences" type="checkbox"/>Conferences</p>
                    <p><input id="Workshops" name="interest-Workshops" type="checkbox"/>Workshops</p>
                    <p><input id="Courses" name="interest-Courses" type="checkbox"/>Courses</p>
                    <p><input id="Funding Opportunities" name="interest-Funding Opportunities" type="checkbox"/>Funding Opportunities</p>
                    <p><input id="Job opportunities" name="interest-Job opportunities" type="checkbox"/>Job opportunities</p>

  ...
  render() {
    return (
      <div className="contentWrapper__base contentWrapper--thin__base">
            <h1>Discover</h1>
            <form className="form__base">
                <label htmlFor="name">By name: </label>
                <input id="name" type="text" placeholder="Enter their name..."/>
                ...
                <input id="course" type="text" placeholder="Enter course/programme..."/>
                ...
                <div>
                    <button className="button__base" type="submit">Search</button>
                </div>
            </form>
        </div>
    );
